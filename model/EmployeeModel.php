...
class Employee extends DbOperation
{
	...
	function getAllEmpBloodInfo()
	{
		...
		$columnsName = "emp.eId,emp.eEmployeeCodeNumber,emp.eFirstName,emp.eLastName,bld.bName,emp.ePhoneNumberPersonal,emp.ePhoneNumberOffice,dpt.dptName,desi.desiDesignationName";
		//database column name
