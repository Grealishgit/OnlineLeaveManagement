			...
			<div id="wrapper">
				...
				<div id="sidebar-wrapper">
					<ul class="sidebar-nav">
						...
						<li>
							<a style="color:#DAA520;" href="ListOfUserBlood.php"><i class="fas fa-heartbeat"></i> Blood
								Group</a>
						</li>
						<li>
									...
									<div class="col-lg-6 col-md-offset-6 form-group">
										...
										<div class="input-group">
											...
											while ($row = mysqli_fetch_array($bldResult)) {
												if ($row['bId'] == @$cat) {
											?>
													<option selected value='<?php echo $row['bId']; ?>'><?php echo $row['bName']; ?>
													</option>
												<?php
												} else {
												?>
									...
									<div class="form-group">
										...
										?>
											<tr>
												...
												<td><?php echo "P: " . $row2['ePhoneNumberPersonal'] . "<br/>O: " . $row2['ePhoneNumberOffice'] ?>
												</td>
											</tr>
										<?php
										}
