								...
								<form role="form" action="../controller/LeaveApplicationController.php" method="post">
									...
									if (isset($_SESSION['livApplicationDetailsForOneUserId'])) {
										...
										while ($historyForLeave = mysqli_fetch_array($livHistory)) {
											echo "<br/><span style='color:#DAA520;' class='glyphicon glyphicon-road'></span> You were on Leave from <b style='color:#DAA520;'>" . $historyForLeave['lLeaveFromDate'] . "</b> To <b style='color:#DAA520;'>" . $historyForLeave['lLeaveToDate'] . "</b>. Total <b style='color:#DAA520;'>" . $historyForLeave['lTotalLeaveDays'] . "</b> Day/s.<br/>";
										}
											...
											<div class="form-horizontal col-md-6">
												...
												<div class="form-group col-md-12">
													...
													<div class="col-sm-6 radio">
														...
														?>
															<label><input type="radio" name="userLeaveType" id="userLeaveType"
																	value="<?php echo $empResult['lId']; ?>"><?php echo $empResult['lType']; ?></label></br>
														<?php
														}
														?>
													</div>
												...
												<div class="form-group col-md-12">
													...
													<div class="col-sm-6">
														<input type="date" class="form-control" value="<?php  ?>" name="userLeaveFrom"
															id="userLeaveFrom" required>
													</div>
												...
												<div class="form-group col-md-12">
													...
													<div class="col-sm-6">
														<input type="date" class="form-control" value="<?php  ?>" name="userLeaveTo"
															id="userLeaveTo" required>
													</div>

												</div>

												<h3 align="center"><button type="submit" value="<?php echo $applicantUserId; ?>"
														name="btnUserLeaveApplicationUpdate" class="btn btn-success">Update</button>
												</h3>
											...
											<tbody>
												...
												?>
													<tr>
														...
														<td><button type="submit" value="<?php echo $row['lId'] ?>"
																name="btnApproved" class="btn btn-success">Approve</button> <button
																type="submit" value="<?php echo $row['lId'] ?>"
																name="btnApplicationDetailsBeforeApprove"
																class="btn btn-info">Details</button> <button type="submit"
																value="<?php echo $row['lId'] ?>" name="btnNotApproved"
