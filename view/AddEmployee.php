					...
					<div class="container-fluid">
						<div class="row">
							<div class="col-lg-12">
								...
								if ($cat !== null && strlen($cat) > 0 && !is_numeric($cat)) {
								...
								<form role="form" action="../controller/AddEmployeeController.php" method="post">
									...
									<div class="form-group">
										...
										while ($row = mysqli_fetch_array($dptResult)) {
											if ($row['dptId'] == @$cat) {
										?>
												<option selected value='<?php echo $row['dptId']; ?>'><?php echo $row['dptName']; ?>
												</option>
											<?php
											} else {
											?>
									...
									<div class="form-group">
										...
										?>
											<option value='<?php echo $row2['desiId']; ?>'>
												<?php echo $row2['desiDesignationName']; ?></option>
										<?php
										}
										echo "</select>";
										?>
									...
									<div class="form-group">
										...
										<input type="text" class="form-control" placeholder="Employee Code Number ...."
											name="empCodeNum" id="empCodeNum">
									...
									<div class="form-group">
										...
										<input type="email" class="form-control" placeholder="Employee Email Address ...."
											name="empEmailAddress" id="empEmailAddress">
									...
									<div class="form-group">
										...
										<input type="password" class="form-control" placeholder="Employee Login Password ...."
											name="empLoginPass" id="empLoginPass">
									...
									<div class="form-group">
										...
										<input type="text" class="form-control" placeholder="Employee Last Name ...."
											name="empLastName" id="empLastName">
									...
									<div class="form-group">
										...
										<input type="date" class="form-control" placeholder="Employee Date Of Birth ...."
											name="empDoB" id="empDoB">
									...
									<div class="form-group">
										...
										?>
											<option value='<?php echo $bloodRow['bId']; ?>'><?php echo $bloodRow['bName']; ?>
											</option>
										<?php
										}
										echo "</select>";
									...
									<div class="form-group">
										...
										<input type="text" class="form-control" placeholder="Employee Phone Number ...."
											name="empPhoneNumPersonal" id="empPhoneNumPersonal">
									...
									<div class="form-group">
										...
										<input type="text" class="form-control" placeholder="Employee Phone Number ...."
											name="empPhoneNumOffice" id="empPhoneNumOffice">
									...
									<div class="form-group">
										...
										<input type="text" class="form-control" placeholder="Employee Permanent Address ...."
											name="empParmanentAddress" id="empParmanentAddress">
									...
									<div class="form-group">
										...
										<input type="text" class="form-control" placeholder="Employee Present Address ...."
											name="empPresentAddress" id="empPresentAddress">
