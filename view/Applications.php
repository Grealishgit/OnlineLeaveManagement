											...
											<tbody>
												...
												?>
													<tr>
														...
														<td><?php echo $row['eFirstName'] . " " . $row['eLastName'] . "<br/>User Id :" . $row['lEmployeeCodeNumberWhoApply'] ?>
														</td>
														...
														<td><button type="submit" value="<?php echo $row['lId'] ?>"
																name="btnRecomand" class="btn btn-success">Recommend</button>
															<button type="submit" value="<?php echo $row['lId'] ?>"
																name="btnApplicationDetails"
