                    ...
                    <div class="col-lg-12">
                        ...
                        <form role="form" action="../controller/AddEmployeeController.php" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <tr>
                                    <td><a
                                            href="../view/UsersLeaveDetails.php?cat=<?php echo $empResult['eEmployeeCodeNumber'] ?>"><?php echo $empResult['eEmployeeCodeNumber'] ?></a>
                                    </td>
                                    ...
                                    <?php
												...
												?>
                                    <td><button type="submit" value="<?php echo $empResult['eId'] ?>" name="btnVerify"
                                            class="btn btn-success">In-Active</button><?php if ($empResult['eEmpType'] == 3) { ?>
                                        <button type="submit" value="<?php echo $empResult['eId'] ?>"
                                            name="btnCoordinator" class="btn btn-info">Normal
                                            User</button><?php } elseif ($empResult['eEmpType'] == 2) { ?> <button
                                            type="submit" value="<?php echo $empResult['eId'] ?>" name="btnCoordinator"
                                            class="btn btn-primary">Coordinator</button><?php } else { ?> <button
                                            type="submit" value="<?php echo $empResult['eId'] ?>" name="btnCoordinator"
                                            class="btn btn-danger disabled">Admin</button><?php } ?>
                                    </td>
                                    <?php
												} else {
												?>
                                    <td><button type="submit" value="<?php echo $empResult['eId'] ?>" name="btnVerify"
                                            class="btn btn-warning">Active</button></td>
                                    <?php
												}
												?>
                                </tr>
